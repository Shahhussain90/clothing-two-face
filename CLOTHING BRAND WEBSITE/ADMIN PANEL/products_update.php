...
if (isset($_POST['update_product'])) {
    ...
    if(empty($product_name) || empty($product_price) || empty($product_image)){
       $message[]='please fill form';
        ...
        $update = "UPDATE `main_products` SET product_name='$product_name',product_price='$product_price',No_Discount_price='$No_Discount_price',product_description='$product_description',product_image='$product_image'
        WHERE product_id=$id";
