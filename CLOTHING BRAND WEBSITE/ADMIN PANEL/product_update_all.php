...
if (isset($_POST['update_product'])) {
    ...
    if(empty($product_name) || empty($product_price) || empty($product_image)){
       $message[]='please fill form';
        ...
        $update = "UPDATE `all_products` SET product_name='$product_name',product_price='$product_price',No_Discount_price='$No_Discount_price',product_description='$product_description',product_alt_text='$product_alt_text',fabric='$fabric',product_image='$product_image'
        WHERE product_id=$id";
        ...
        <div class="img-add-div-form">
            ...
            ?>
                ...
                <form class="card-add-form" action="<?php $_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
                    ...
                    <textarea form="formmmm" cols="66" style="white-space: pre-wrap;" id="product_description" value="<?php echo $row['product_description']; ?>" name="product_description" class="update-input prod-desc" required></textarea>
                    <!-- <input type="text" class="update-input" placeholder="product description" value="" name="product_description" > -->
