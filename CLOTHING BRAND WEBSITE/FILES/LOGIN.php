...
<body>
    <form action="" method="post" class="LOGIN-FORM">
        ...
        <div class="input-fields-div">
            <input type="email" class="inputs" name="email" placeholder="Email" value="<?php echo $id; ?>" required>
            <input type="password" name="password" class="inputs" placeholder="Password" value="<?php echo $pass; ?>" required>
